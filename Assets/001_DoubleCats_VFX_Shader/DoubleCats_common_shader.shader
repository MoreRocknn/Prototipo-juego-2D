//Warning!!!This shader is not performance optimized at all and should not be introduced into the project
// Author:DoubleCats
//Personal website
//https://www.artstation.com/user-427421
//https://twitter.com/doublecats1
Shader "Effect/DoubleCats/DoubleCats__common_shader"
{
	Properties
	{
	...
	CustomEditor "DoubleCats_Common_shader_GUI"
